...
export type DogResolvers<ContextType = any, ParentType extends ResolversParentTypes['Dog'] = ResolversParentTypes['Dog']> = ResolversObject<{
  breed?: Resolver<Maybe<ResolversTypes['DogBreed']>, ParentType, ContextType>;
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  getDogById?: Resolver<Maybe<ResolversTypes['Dog']>, ParentType, ContextType, RequireFields<QueryGetDogByIdArgs, 'id'>>;
}>;
